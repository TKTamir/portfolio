export const Impressum = () => {
  return (
    <div className="impressum">
      ...
      <p>
        Tamir Nissim Kahalany <br />
        Frankfurter Allee 86C
        <br />
        10247 Berlin <br />
      </p>
      <p>
        ...
        <br />
        Tamir Nissim Kahalany
        <br />
      </p>
      <p>
        <strong>Kontakt:</strong> <br />
        Telefon: +49-015252457539
        <br />
        E-Mail: <a href="mailto:tamirkahalany@gmail.com">tamirkahalany@gmail.com</a>
        <br />
      </p>
      <p>
